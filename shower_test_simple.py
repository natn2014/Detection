...
class MainWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Water Leakage Inspection System 581A-R")
        self.setGeometry(100, 100, 1600, 900)

        # State variables
        self.inspection_running = False
        self.ng_counts = {"Top Left บนซ้าย": 0, "Top Right บนขวา": 0, "Bottom Left ล่างซ้าย": 0, "Bottom Right ล่างขวา": 0}
    ...
    def start_inspection(self):
        ...
        for position in self.ng_counts:
            self.ng_counts[position] = 0  # Reset NG counts
    ...
    def finish_inspection(self):
        ...
        self.total_ok_count += 1  # Increment OK counter for completed cycle
        self.total_ng_count += sum(self.ng_counts.values())  # Add NG counts from current cycle
        ...
        while True:
            ...
            if ret:
                ...
                if self.inspection_running:
                    if "class2" in detected_classes:  # "class2" is NG
                        self.ng_counts[position] += 1
                        self.update_ng_label(position)
    ...
    def update_graph(self):
        ...
        ax.plot(range(1, len(self.inspection_durations) + 1), self.inspection_durations, marker="o", color="b", label="M/C Inspection Duration")
        ...
        ax.set_title("Inspection Durations and Cyle Times")
